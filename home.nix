...

{
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrulesrc"."0410fd2f-6fd4-4802-8383-fdca83c97e39"."wmclass" = "chrome-";
      "kwinrulesrc"."0410fd2f-6fd4-4802-8383-fdca83c97e39"."wmclasscomplete" = true;
      "kwinrulesrc"."0410fd2f-6fd4-4802-8383-fdca83c97e39"."wmclassmatch" = 2;
      ...
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."Description" = "Teams";
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."desktops" = "2e5b6191-8032-4931-bdfb-9d732b473ac8";
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."desktopsrule" = 3;
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."position" = "1896,0";
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."positionrule" = 3;
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."size" = "1544,1440";
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."sizerule" = 3;
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."wmclass" = "teams-for-linux";
      "kwinrulesrc"."2d14adb1-f250-4d30-b3d6-30d4eb2eccc9"."wmclassmatch" = 1;
      ...
      "kwinrulesrc"."86dc4647-b437-4589-aa9d-6e9103212093"."maximizehoriz" = true;
      "kwinrulesrc"."86dc4647-b437-4589-aa9d-6e9103212093"."maximizehorizrule" = 3;
      ...
      "kwinrulesrc"."86dc4647-b437-4589-aa9d-6e9103212093"."wmclass" = "firefox firefox";
      ...
      "kwinrulesrc"."General"."rules" = "a7abdee9-5089-43f6-853f-3bf76cae5f31,86dc4647-b437-4589-aa9d-6e9103212093,e3dee0fc-df27-44a5-92ba-a07ce2b29719,dfa51678-15a5-4797-aa68-e710240ff290,deb6e47f-c93b-43f0-a849-65962a43597a,3cf8c79b-7128-49b6-99e3-d296b840bc2f,0410fd2f-6fd4-4802-8383-fdca83c97e39,dd191b02-ea20-4fc8-aec5-cfe1f47b1fb2,0c01199b-9614-465d-8e66-a1e8c6ae5c87,bc3923b0-7e5f-495f-94b5-ca0254774331,6d99e553-0e22-4e3d-b9dd-1bea4c3684eb";
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."Description" = "Teams";
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."desktops" = "2e5b6191-8032-4931-bdfb-9d732b473ac8";
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."desktopsrule" = 3;
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."position" = "1896,0";
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."positionrule" = 3;
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."size" = "1545,1440";
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."sizerule" = 3;
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."wmclass" = "teams-for-linux";
      "kwinrulesrc"."6d99e553-0e22-4e3d-b9dd-1bea4c3684eb"."wmclassmatch" = 1;
      ...
      "kwinrulesrc"."a7abdee9-5089-43f6-853f-3bf76cae5f31"."title" = "^(?!.*\\b(YouTube|Bitwarden)\\b).*Google Chrome.*$";
      ...
      "kwinrulesrc"."deb6e47f-c93b-43f0-a849-65962a43597a"."activityrule" = 2;
      "kwinrulesrc"."deb6e47f-c93b-43f0-a849-65962a43597a"."desktops" = "453a1516-206a-40c1-9b01-45e804ab8836";
      "kwinrulesrc"."deb6e47f-c93b-43f0-a849-65962a43597a"."desktopsrule" = 2;
      "kwinrulesrc"."deb6e47f-c93b-43f0-a849-65962a43597a"."position" = "0,0";
      "kwinrulesrc"."deb6e47f-c93b-43f0-a849-65962a43597a"."positionrule" = 2;
      "kwinrulesrc"."deb6e47f-c93b-43f0-a849-65962a43597a"."size" = "1323,1440";
      "kwinrulesrc"."deb6e47f-c93b-43f0-a849-65962a43597a"."sizerule" = 2;
      ...
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."title" = "Zoho Mail (patrick@hfmnn.com)";
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."titlematch" = 2;
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."types" = 1;
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."wmclass" = "desktop Zoho Mail";
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."wmclasscomplete" = true;
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."wmclassmatch" = 2;
