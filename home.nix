...

{
  ...
  programs.plasma = {
    ...
    configFile = {
      ...
      "kwinrulesrc"."86dc4647-b437-4589-aa9d-6e9103212093"."wmclass" = "chrome google-chrome";
      ...
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."title" = "Inbox - Zoho Mail (patrick@hfmnn.com)";
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."titlematch" = 2;
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."types" = 1;
      "kwinrulesrc"."dfa51678-15a5-4797-aa68-e710240ff290"."wmclass" = "Zoho Mail - Desktop";
